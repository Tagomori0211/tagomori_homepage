/** 小さなインラインアイコン群（装飾用。意味はテキスト側で伝える） */
...
export function MailIcon({ size = 18 }: { size?: number }) {
  return (
    <svg viewBox="0 0 24 24" width={size} height={size} aria-hidden="true">
      <rect x="3" y="5.5" width="18" height="13" fill="none" stroke="currentColor" strokeWidth="1.6" />
      <path d="M3.5 6.5 12 13l8.5-6.5" fill="none" stroke="currentColor" strokeWidth="1.6" />
    </svg>
  );
}
